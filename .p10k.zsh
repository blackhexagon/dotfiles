# Generated by Powerlevel10k configuration wizard on 2025-08-28 at 15:02 CEST.
...
# round separators, round heads, blurred tails, 1 line, compact, few icons, concise,
...
() {
  ...
  function my_git_formatter() {
    ...
    local      clean='%254F' # very light gray/white
    local   modified='%254F' # very light gray/white
